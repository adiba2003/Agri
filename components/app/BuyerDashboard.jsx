...
import shoppingCart from '../assets/Shopping _Cart.png'; // rename করে small underscore ব্যবহার করো
...
export default function BuyerDashboard({ navigation }) {
  ...
  // ✅ Recent orders data
  const recentOrders = [
    { id: 1, name: "Premium Basmati Rice - 5kg", orderId: "#1234", status: "Delivered", statusColor: "#4CAF50", image: riceImg },
    { id: 2, name: "Fresh Carrots - 2kg", orderId: "#1235", status: "In Transit", statusColor: "#FF9800", image: carrotImg },
    { id: 3, name: "Fresh Tomatoes - 3kg", orderId: "#1236", status: "Delivered", statusColor: "#4CAF50", image: tomatoImg }
  ];

  // ✅ Quick actions
  const quickActions = [
    { title: "Browse Products", subtitle: "Find fresh produce", image: cartImg, route: "BuyerBrowse" },
    { title: "My Orders", subtitle: "Track deliveries", image: orderImg, route: "BuyerOrder" },
    { title: "Shopping Cart", subtitle: "5 items ready", image: shoppingCart, route: "Cart" },
    { title: "Learn", subtitle: "Farming guides", image: booksImg, route: "BuyerLearn" },
  ];
  ...
  const navItems = [
    ...
    { name: "Cart", image: cartImg, notification: 5, route: "Cart" },
...
const styles = StyleSheet.create({
  ...
  statCard: { flex: 1, backgroundColor: '#fff', borderRadius: 12, padding: 15, marginHorizontal: 5, alignItems: 'center', elevation: 3 },
  ...
  actionCard: { width: '48%', backgroundColor: '#fff', borderRadius: 12, padding: 15, marginBottom: 15, flexDirection: 'row', alignItems: 'center', elevation: 3 },
  ...
  orderCard: { backgroundColor: '#fff', borderRadius: 12, padding: 15, marginBottom: 10, flexDirection: 'row', alignItems: 'center', elevation: 3 },
