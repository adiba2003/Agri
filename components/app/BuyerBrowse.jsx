...
export default function BuyerBrowse({ navigation }) {
  ...
  const products = [
    { id: 1, name: "Premium Basmati Rice", farmer: "Rice Fields", price: "$85/kg", location: "Khulna", category: "Grains", image: rice, rating: 4.8 },
    { id: 2, name: "Fresh Carrots", farmer: "Green Valley Farms", price: "$45/kg", location: "Khulna", category: "Vegetables", image: carrot, rating: 4.9 },
    { id: 3, name: "Fresh Tomatoes", farmer: "Green Valley Farms", price: "$60/kg", location: "Dhaka", category: "Vegetables", image: tomato, rating: 4.5 },
    { id: 4, name: "Organic Potatoes", farmer: "Farm Fresh Co.", price: "$85/kg", location: "Chittagong", category: "Vegetables", image: potato, rating: 4.2 },
    { id: 5, name: "Sweet Mangoes", farmer: "Mango Garden", price: "$80/kg", location: "Rajshahi", category: "Fruits", image: mango, rating: 4.8 },
    { id: 6, name: "Fresh Milk", farmer: "Dairy Pure", price: "$1.20/L", location: "Dhaka", category: "Dairy", image: milk, rating: 4.3 },
    { id: 7, name: "Eggs", farmer: "Happy Hens", price: "$0.25/egg", location: "Sylhet", category: "Poultry", image: eggs, rating: 4.6 },
  ];
  ...
  const sortOptions = ["Newest First", "Price: Low to High", "Price: High to Low", "Highest Rated", "Most Popular"];
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.navigate("BuyerDashboard")} style={styles.backButton}>
